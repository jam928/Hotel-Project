...
%>
<h1>Write review for room <%=room_no%> @ Hotel <%=hotelid%></h1>
<form name="review_form" action="review_submit_room.jsp?room_no=<%=room_no%>&hotelid=<%=hotelid%>" method="post" onsubmit="return isFilled()">
	<div >
