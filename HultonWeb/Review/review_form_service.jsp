...
%>
<h1 >Write review for <%=stype%> service @ Hotel <%=hotelid%></h1>
<form name="review_form_service" action="review_submit_service.jsp?stype=<%=stype%>&hotelid=<%=hotelid%>" method="post" onsubmit="return isFilled()">
	<div >
